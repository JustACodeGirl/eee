        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("maxlength") !== undefined) {
              message = "长度最长为 '" + $this.attr("maxlength") + "<!-- data-validation-maxlength-message to override -->";
            ...
            if ($this.attr("minlength") !== undefined) {
              /*message = "密码为" + $this.attr("minlength")+"到"+$this.attr("maxlength")+"位字符组成";*/
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() == "email") {
              message = "邮箱格式错误！<!-- data-validation-validemail-message to override -->";
          ...
          $this.bind(
            ...
            function (e, params) {
              ...
              if (errorsFound.length) {
                ...
                $helpBlock.html("<ul role=\"alert\"><li class=\"text-danger\">" + errorsFound.join("</li><li>") + "</li></ul>");
              } else {
      ...
      override : function (newDefaults) {
		...
		builtInValidators: {
			...
			number: {
				...
				type: "regex",
				regex: "([+-]?\\\d+(\\\.\\\d*)?([eE][+-]?[0-9]+)?)?",
				message: "Must be a number<!-- data-validation-number-message to override -->"
			},
			integer: {
				name: "Integer",
				type: "regex",
			...
			required: {
				name: "Required",
				type: "required",
				message: "请填入此项信息<!-- data-validation-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
