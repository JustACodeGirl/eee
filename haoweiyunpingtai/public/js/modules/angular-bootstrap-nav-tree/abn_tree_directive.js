    ...
    '$timeout', function($timeout) {
      return {
        ...
        link: function(scope, element, attrs) {
          var select_branch_by_treeid, error, expand_all_parents, expand_level, for_all_ancestors, for_each_branch, get_parent, n, on_treeData_change, select_branch, selected_branch, tree;
          error = function(s) {
            console.log('ERROR:' + s);
            debugger;
            return void 0;
          ...
          select_branch_by_treeid = function(treeid) {
              for_each_branch(function(b) {
                  if (b.treeId === treeid) {
                      return $timeout(function() {
          ...
          if (attrs.initialSelection != null) {
            for_each_branch(function(b) {
              if (b.treeId === attrs.initialSelection) {
                return $timeout(function() {
                  return select_branch(b);
                });
              }
          ...
          if (scope.treeControl != null) {
            if (angular.isObject(scope.treeControl)) {
              ...
              tree.select_by_treeid = function (treeid) {
                return select_branch_by_treeid(treeid);
              };
